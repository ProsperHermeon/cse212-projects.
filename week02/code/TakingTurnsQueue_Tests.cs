...
public class TakingTurnsQueueTests
{
    ...
    // causing LIFO behavior instead of FIFO. TakingTurnsQueue.GetNextPerson was not re-enqueueing people
    // with infinite turns (turns <= 0). Test Result: PASS after fixes. 
    ...
    // Defect(s) Found: PersonQueue.Enqueue was inserting at index 0 (front) instead of adding to the back,
    // causing LIFO behavior instead of FIFO. Test Result: PASS after fixes. 
